            ...
            >
              <View style={styles.propertyCardTop}>
                <Text
                  style={[
                    styles.propertyName,
                    selected && styles.propertyNameActive,
                  ]}
                >
                  {property.name}
                </Text>
                <Text
                  style={[styles.countPill, selected && styles.countPillActive]}
                >
              ...
              <Text
                style={[
                  styles.propertyMeta,
                  selected && styles.propertyMetaActive,
                ]}
              >
                {property.address}
              </Text>
        ...
        {wholeHouseProperties.map((property) => {
          ...
          return (
            ...
            >
              ...
              >
                Giá thuê: {formatVnd(property.monthlyRent)} đ/tháng
              </Text>
            </TouchableOpacity>
          )
        })}
        ...
        householdMembers.map((member, index) => (
          <View key={member.id} style={styles.memberCard}>
            ...
            <TextInput
              style={styles.input}
              value={member.phone}
              onChangeText={(v) => updateHouseholdMember(member.id, 'phone', v)}
              keyboardType='phone-pad'
            ...
            <TextInput
              style={styles.input}
              value={member.cccd}
              onChangeText={(v) => updateHouseholdMember(member.id, 'cccd', v)}
              keyboardType='number-pad'
              placeholder='Số CCCD'
              placeholderTextColor={Colors.textMuted}
            />
